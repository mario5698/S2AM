...
class _PokeDetailPageState extends State<PokeDetailPage> {
  ...
  void initState() {
    ...
    AvatarImage = widget.pokemon.correct
  ...
  Widget get rating {
    return new Row(
      ...
      children: <Widget>[
        ...
        new Text('${widget.pokemon.rating}/10',
  ...
  Widget get pokeType {
    if (!widget.pokemon.correct) {
      return Tooltip(
          message: "Unknown",
          child:
              Container(width: 75, child: Image.asset("assets/unknown.png")));
    } else if (widget.pokemon.types.length == 1) {
      return Tooltip(
          message: widget.pokemon.firstType.capitalize(),
          child: Container(
              width: 75,
              child: Image.asset("assets/${widget.pokemon.firstType}.png")));
    } else {
      return Row(
        ...
        children: <Widget>[
          Tooltip(
              ...
              child: Container(
                  width: 75,
                  child:
                      Image.asset("assets/${widget.pokemon.firstType}.png"))),
          Tooltip(
              message: widget.pokemon.secondType.capitalize(),
              child: Container(
                  width: 75,
                  child:
                      Image.asset("assets/${widget.pokemon.secondType}.png")))
        ],
      );
    }
  }
  ...
  Widget get pokeStats {
    TextStyle _style = TextStyle(fontSize: 15);
    return Container(
              ...
              children: <Widget>[
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Text("HP: ${widget.pokemon.hp}", style: _style),
                  ),
                ),
                Card(
                  color: Colors.redAccent,
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("Att: ${widget.pokemon.attack}",
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("Def: ${widget.pokemon.defense}",
                        style: TextStyle(fontSize: 15)),
                  ),
                ),
              ],
            ...
            Row(
              ...
              children: <Widget>[
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("S. Att: ${widget.pokemon.specialAttack}",
                        style: TextStyle(
                          fontSize: 15,
                        )),
                  ),
                ...
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("S. Def: ${widget.pokemon.specialDefense}",
                        style: TextStyle(fontSize: 15)),
                  ),
                ),
                Card(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("Speed: ${widget.pokemon.speed}",
                        style: TextStyle(fontSize: 15)),
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text('${widget.pokemon.name.capitalize()}',
